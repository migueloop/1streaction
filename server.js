...
var Shapes = require('./models/shape');
var Character = {};
...
/**
 * GET /api/shapes
 * Create shapes by default
 */

app.get('/api/createShapes', function(req, res, next) {
  var seed = require('./app/dbseed')
  var shapesCollection = seed()

  Shapes.create(shapesCollection, function(err, shapesCollection){
  	if(err) console.log(err);
  	else{
      console.log('Shapes default import done!');
